...
CREATE TABLE public.user_images ( id integer NOT NULL,
                                             user_id integer, file_name character varying(255),
...
ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY
    ( SEQUENCE NAME public.user_images_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1);
                                                            ...
                                                            last_name character varying(255),
                                                                                email character varying(255),
                                                                                                password character varying(60),
                                                                                                                   is_admin integer, created_at timestamp without time zone,
                                                                                                                                                                       updated_at timestamp without time zone);
...
--
 COPY public.user_images (id, user_id, file_name, created_at, updated_at)
FROM stdin;
...
ALTER TABLE ONLY public.user_images ADD CONSTRAINT user_images_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.user_images ADD CONSTRAINT user_images_user_id_fkey
